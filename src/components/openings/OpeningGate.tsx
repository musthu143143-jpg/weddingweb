...
function TanjoreDoorPanel({ t, side }: { t: TemplateTheme; side: "left" | "right" }) {
  return (
    <div
      className="relative h-full w-full overflow-hidden bg-[#32100E]"
      style={{
        backgroundImage: "url('/images/tanjore-temple-doors.jpg')",
        backgroundPosition: side === "left" ? "left center" : "right center",
        backgroundRepeat: "no-repeat",
        backgroundSize: "200% 100%",
        boxShadow: side === "left" ? "inset -18px 0 28px #09020455" : "inset 18px 0 28px #09020455",
      }}
    />
  );
}
