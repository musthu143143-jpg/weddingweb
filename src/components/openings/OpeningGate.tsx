...
function TanjoreDoorPanel({ t, side }: { t: TemplateTheme; side: "left" | "right" }) {
  return (
    <div
      ...
      style={{
        borderColor: `${t.gold}cc`,
        boxShadow: "0 0 55px #16030699 inset",
    ...
    >
      <span className="pointer-events-none absolute inset-0 bg-gradient-to-br from-[#16030666] via-transparent to-[#F0C86A22]" />
      ...
      <svg viewBox="0 0 100 240" className="absolute inset-5 h-[calc(100%-2.5rem)] w-[calc(100%-2.5rem)] opacity-30" preserveAspectRatio="none" aria-hidden="true">
