                    ...
                    {isOpen && (
                      <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }} exit={{ height: 0, opacity: 0 }} transition={{ duration: 0.3 }}>
                        <div className="space-y-4 border-t border-gold/15 px-5 py-5">
                          ...
                          {s.id === "story" && <StoryPanel moments={draft.data.story} onChange={(story) => patchData({ story })} />}
...
function StoryPanel({ moments, onChange }: { moments: StoryMoment[]; onChange: (moments: StoryMoment[]) => void }) {
